...
<input type="password"class="form-control"id="exampleInput Password1" name="password1">
</div>
<button type="submit"class="btn btn-primary button" name="login"  ><a class="btn" href="index.php">Submit</a></button>
<br>
